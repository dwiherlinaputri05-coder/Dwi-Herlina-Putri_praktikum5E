...
class _DashboardPageState extends State<DashboardPage>
  ...
  List<Map<String, dynamic>> get _filteredBarang {
    return _barangList.where((barang) {
      final matchSearch = barang['nama'].toLowerCase().contains(
        _searchQuery.toLowerCase(),
      );
      final matchFilter =
          _filterKategori == "Semua" || barang['kategori'] == _filterKategori;
      return matchSearch && matchFilter;
    }).toList();
  }

  double get totalHarga =>
      _filteredBarang.fold(0, (sum, barang) => sum + barang['harga']);
  ...
  void _editBarang(int index) {
    final TextEditingController namaController = TextEditingController(
      text: _barangList[index]['nama'],
    );
    final TextEditingController hargaController = TextEditingController(
      text: _barangList[index]['harga'].toString(),
    );
                  ...
                  children: [
                    Expanded(
                      child: _buildStatCard(
                        "Total Barang",
                        _filteredBarang.length.toString(),
                        Colors.blue,
                        Icons.inventory_2,
                      ),
                    ),
                ...
                child: Column(
                  children: [
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children:
                            ["Semua", "Elektronik", "Komputer", "Furniture"]
                                .map(
                                  (kategori) => Padding(
                                    ...
                                    child: FilterChip(
                                      ...
                                      labelStyle: TextStyle(
                                        color: _filterKategori == kategori
                                            ? Colors.white
                                            : Colors.black,
